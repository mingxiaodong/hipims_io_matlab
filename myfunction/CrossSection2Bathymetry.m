function riverBedPoints_z = CrossSection2Bathymetry(channelBoundPoly,...
    riveBankLine1,riveBankLine2,crossSection3DLines,...
    riverBedPoints_xy) 
...
%
%   riverBedPoints_z = CrossSection2Bathymetry(channelBoundPoly,
%   riveBankLine1,riveBankLine2,crossSection3DLines,riverBedPoints_xy)
%   Generate a vector giving the elevation of riverBedPoints_xy. 
%   channelBoundPoly is a 3-column matrix representing river bound polygon.
%   riveBankLine1 and riveBankLine2 are 2-column matrice representing river 
%   bound lines. crossSection3DLines is a cell consisting of 3-column 
...
%% split river bed polygon(points inside) based on the cross lines
x_bedPoints = riverBedPoints_xy(:,1);
y_bedPoints = riverBedPoints_xy(:,2);
